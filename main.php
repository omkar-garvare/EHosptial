...
<head>
    ...
    <style>
        body {
            background-image: url('image/bb3.jpg'); /* Background image */
        ...
        .card-header {
            background-color: #dc3545; /* Red background for card headers */
        ...
        .jumbotron {
            background-color: #dc3545; /* Red background for jumbotron */
            color: #fff; /* White text color */
            text-align: center;
            padding: 50px;
            margin-bottom: 30px;
